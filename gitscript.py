...
token = os.environ.get("GITHUB_TOKEN2")
if not token:
    raise Exception("No se encontró la variable de entorno GITHUB_TOKEN2.")

username = "pronosticosnumericos"
# Construye la URL remota con el token
remote_url = f"https://{username}:{token}@github.com/{username}/pronosticos_Bayer.git"

# Ruta al repositorio local
repo_path = "/home/sig07/website_Bayer"
